...
SMKFS_STATUS block_cache_read(_SMKFS_MOUNT *mnt, SMKFS_BLOCK block,
                              _SMKFS_BLOCK_BUF **out_buf);
...
/* --- B+ Tree --- */
SMKFS_STATUS btree_search(_SMKFS_MOUNT *mnt, SMKFS_BLOCK root_block, PCCHAR key,
                          ULONGLONG *out_value);
SMKFS_STATUS btree_insert(_SMKFS_MOUNT *mnt, SMKFS_BLOCK root_block, PCCHAR key,
                          ULONGLONG value, SMKFS_BLOCK *new_root);
SMKFS_STATUS btree_delete(_SMKFS_MOUNT *mnt, SMKFS_BLOCK root_block, PCCHAR key,
                          SMKFS_BLOCK *new_root);
SMKFS_STATUS btree_iterate(_SMKFS_MOUNT *mnt, SMKFS_BLOCK root_block,
                           LONG (*cb)(PCCHAR key, ULONGLONG value, PVOID ctx),
                           PVOID ctx);
SMKFS_STATUS btree_node_read(_SMKFS_MOUNT *mnt, SMKFS_BLOCK block,
                             _SMKFS_BTREE_NODE *node, PVOID payload,
                             SIZE_T payload_size);
SMKFS_STATUS btree_node_write(_SMKFS_MOUNT *mnt, SMKFS_BLOCK block_id,
                              const _SMKFS_BTREE_NODE *node, PCVOID payload,
                              SIZE_T payload_size);
