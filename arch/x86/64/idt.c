/*
 * arch/x86/64/idt.c - Interrupt Descriptor Table (64-bit)
 * Author:   amity
 * Date:     Mon Aug 31 14:17:57 2026
...
extern void load_idt(ULONG_PTR);
...
static int idt_install(void) {
  ...
  /* Double fault (vector 8) uses IST1 for guaranteed stack */
  idt[8].ist = 1;
