...
void serial_putc_default(char c) { serial_putc(&serial_com1, c); }

void serial_puts_default(const char *s) { serial_puts(&serial_com1, s); }
...
int serial_getc_default(void) { return serial_getc(&serial_com1); }
