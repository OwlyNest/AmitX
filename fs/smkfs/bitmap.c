...
VOID bitmap_set(smkfs_mount_t *mnt, SMKFS_BLOCK block) {
    ...
    SMKFS_OFFSET byte_offset = idx / 8;
    SMKFS_OFFSET bit_offset = idx % 8;
    SMKFS_BLOCK bitmap_block = mnt->sb.bitmap_start + (byte_offset / SMKFS_BLOCK_SIZE);
    SMKFS_OFFSET block_offset = byte_offset % SMKFS_BLOCK_SIZE;
