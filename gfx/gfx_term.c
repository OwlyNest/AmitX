 ...
 * Initialize terminal
 * ======================================================================= */
void gfx_term_init(int x, int y, int w, int h,
...
void gfx_term_move_cursor(int col, int row) {
    term_cx = col;
    term_cy = row;
    if (term_cx < 0) term_cx = 0;
    if (term_cx >= term_cols) term_cx = term_cols - 1;
    if (term_cy < 0) term_cy = 0;
